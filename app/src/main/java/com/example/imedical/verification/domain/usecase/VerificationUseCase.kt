...
class VerificationUseCase @Inject constructor(private val iVerificationRepository: IVerificationRepository)
    : BaseUseCase<DataWrapper<String>, VerificationUseCase.VerificationParams>() {
